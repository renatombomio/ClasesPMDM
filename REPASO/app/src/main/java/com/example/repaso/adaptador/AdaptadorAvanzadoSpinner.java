package com.example.repaso.adaptador;
...
public class AdaptadorAvanzadoSpinner extends BaseAdapter {
    ...
    //si tengo una lista y tengo una posición, tengo elemento
    //lista.get(position)
    @Override
    ...
    //obtengo el  ID elemento que esta en una posicion
    //posicion
    @Override
    ...
    //se encarga de pintar cada una de las filas y de rellenarlas
    @Override
